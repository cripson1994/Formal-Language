...
public class LexerTest {
    ...
    public void  initValidationData() {
        ...
        valid[5] = Arrays.asList("TVAR(\"var\", 0, 0, 2)", "TIF(\"if\", 0, 4, 5)", "TEQ(\"=\", 0, 7, 7)", "TDIGIT(\"10\", 0, 9, 10)");
        valid[6] = Arrays.asList("TDIGIT(\"435.0e4\", 0, 0, 6)", "TNEQ(\"!=\", 0, 8, 9)", "TDIGIT(\"435000\", 0, 11, 16)");
        valid[7] = Arrays.asList("TVAR(\"var\", 6, 1, 3)", "IDENT(\"x\", 6, 5, 5)", "TEQ(\"=\", 6, 6, 6)", "IDENT(\"cthen\", 6, 7, 11)",
                "TDIGIT(\"-34\", 6, 12, 14)", "TSEP(\";\", 6, 15, 15)");
        valid[8] = Arrays.asList("IDENT(\"_x234\", 0, 0, 4)", "TNEQ(\"!=\", 0, 6, 7)", "TDIGIT(\"67\", 0, 9, 10)");
        valid[9] = Arrays.asList("IDENT(\"x\", 0, 0, 0)", "TEQC(\"==\", 0, 1, 2)", "IDENT(\"c\", 0, 3, 3)", "TDIGIT(\"-1\", 0, 4, 5)");
        valid[10] = Arrays.asList("TWRITE(\"write\", 1, 33, 37)", "TRPAREN(\"(\", 1, 39, 39)", "TDIGIT(\"5\", 1, 40, 40)",
                "TGT(\">\", 1, 41, 41)", "TDIGIT(\"7\", 1, 42, 42)", "TLPAREN(\")\", 1, 43, 43)");
        valid[11] = Arrays.asList("TDIGIT(\"12\", 0, 0, 1)", "IDENT(\"zxc\", 0, 2, 4)");
        valid[12] = Arrays.asList("IDENT(\"this_is_long_variables_name\", 0, 0, 26)");
        valid[13] = Arrays.asList("IDENT(\"ifthen\", 0, 0, 5)", "TWRITE(\"write\", 0, 7, 11)", "TDIGIT(\"1\", 0, 13, 13)");
        valid[14] = Arrays.asList("TDO(\"do\", 0, 0, 1)", "TRBRACES(\"{\", 0, 2, 2)", "TWRITE(\"write\", 0, 3, 7)", "TRPAREN(\"(\", 0, 8, 8)",
                ...
                "IDENT(\"x\", 0, 13, 13)", "TPLUS(\"+\", 0, 14, 14)", "TDIGIT(\"1\", 0, 15, 15)", "TLBRACES(\"}\", 0, 16, 16)",
                "TWHILE(\"while\", 0, 17, 21)", "TRPAREN(\"(\", 0, 22, 22)", "IDENT(\"x\", 0, 23, 23)", "TLT(\"<\", 0, 24, 24)",
                "TDIGIT(\"10\", 0, 25, 26)", "TLPAREN(\")\", 0, 27, 27)");
        valid[15] = Arrays.asList("COMMENT(\"//this is some comment\", 0, 0, 21)","TVAR(\"var\", 1, 1, 3)", "IDENT(\"x\", 1, 5, 5)", "TEQ(\"=\", 1, 7, 7)", "TDIGIT(\"5\", 1, 9, 9)",
                "COMMENT(\"//commen number two\", 2, 1, 19)","TWRITE(\"write\", 3, 1, 5)", "IDENT(\"x\", 3, 7, 7)");
    }
